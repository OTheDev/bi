...
#ifndef BI_SRC_INSTANTIATE_INTEGRAL_HPP_
#define BI_SRC_INSTANTIATE_INTEGRAL_HPP_
...
Extended Signed/Unsigned Integer Types (implementation-defined)
  __int128
  unsigned __int128
*/
...
#define BI_INST_TEMPLATE_FOR_EXTENDED_INTEGRAL_TYPES(FUNC, END)                \
  template FUNC(__int128) END;                                                 \
  template FUNC(unsigned __int128) END;

#define BI_INST_TEMPLATE_FOR_EXTENDED_INTEGRAL_TYPES_ARG(FUNC, ARG)            \
...
#define BI_INST_TEMPLATE_FOR_INTEGRAL_TYPES(FUNC, END)                         \
  ...
  BI_INST_TEMPLATE_FOR_EXTENDED_INTEGRAL_TYPES(FUNC, END)
...
#define BI_INST_TEMPLATE_FOR_INTEGRAL_TYPES_ARG(FUNC, ARG)                     \
  ...
  BI_INST_TEMPLATE_FOR_EXTENDED_INTEGRAL_TYPES_ARG(FUNC, ARG)

// NOLINTEND(cppcoreguidelines-macro-usage)

#endif  // BI_SRC_INSTANTIATE_INTEGRAL_HPP_
